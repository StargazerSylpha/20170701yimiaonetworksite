...
<head>
<meta charset="utf-8">
<title>168游戏加速／下载 - Yimiao Network／一秒网络</title>
	         ...
	         <div id="nav-left" align="center">
	             <ul class="nav nav-pills nav-stacked">
	    	          ...
	    	          <li><a href="#" data-toggle="collapse" data-target="#yimiaoacc-nav">Yimiao Acc／一秒游</a></li>
	    		                      ...
	    		                      <ul style="list-style: none;line-height: 30px;">
	    		                      <li><a href="../yimiaoacc/download.php" style="color: #aaaaaa;">Download／下载</a></li>
	    		                      </ul>
	    		                      </div>
	    	          <li class="active"><a href="#" data-toggle="collapse" data-target="#168acc-nav">168 Acc／168游戏加速</a></li>
	    	                          <div class="collapse in" id="168acc-nav" style="margin-left: -30px;">
	    		                      <ul style="list-style: none;line-height: 30px;">
	    		                      <li><a href="price.html" style="color: #aaaaaa;">Price／价格</a></li>
	    		                      <li><a href="register.html" style="color: #aaaaaa;">Register／注册</a></li>
	    		                      <li><strong>Download／下载</strong></li>
	    		                      <li><a href="pay.html" style="color: #aaaaaa;">Pay／充值</a></li>
	    		                      </ul>
	    		                      </div>
	    	          ...
	    	          <li><a href="#" data-toggle="collapse" data-target="#service-nav">Service／客户服务</a></li>
	                            ...
	                            <div class="col-md-10" id="content-area">
                                           ...
                                           <p><h4><strong>168游戏加速下载／168 Acc Client Download</strong></h4></p>
                                               <table class="table table-striped table-hover" id="168acc-dl-table">
                                               <tr>
                                                   <th>当前版本</th>
                                                   <td><?php 
                                                     echo file_get_contents("https://cdnres.arraycats.net/yimiao/getInfo.php?product=168acc&action=ver");
                                                     ?></td>
                                                   <th>文件大小</th>
                                                   <td><?php 
                                                     echo file_get_contents("https://cdnres.arraycats.net/yimiao/getInfo.php?product=168acc&action=size");
                                                     ?></td>
                                               ...
                                               <tr>
                                                   ...
                                                   <td><?php 
                                                     echo file_get_contents("https://cdnres.arraycats.net/yimiao/getInfo.php?product=168acc&action=date");
                                                     ?></td>
                                             ...
                                             <div class="col-md-6">
                                            <a href="https://cdnres.arraycats.net/yimiao/getInfo.php?product=168acc&action=baidudl" target="_blank" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-save" ></span>&nbsp;百度网盘下载</a>
                                            </div>
                                             <div class="col-md-6">
